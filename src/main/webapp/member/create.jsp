          ...
          <div class="col-xl-10 mx-auto">
            <div class="cta-inner text-center rounded">
              <h2 class="section-heading mb-5">
                <span class="section-heading-lower">회원가입</span>
              </h2>
              <form name="frm" id="frm" method="POST" action="./create.do" class="form-horizontal">
                <div class="form-group">
                  <label for="id" class="col-md-10 control-label" style='font-size: 0.9em;'>아이디 <span class="essential">*</span></label>    
                  <div class="col-md-10" style="display: inline-block;">
                    <input type='text' class="form-control" name='id' id='id' value='' required="required" placeholder="아이디" autofocus="autofocus">
                    <button type='button' id="btn_checkID" class="btn btn-primary btn-md">중복확인</button>
                    <SPAN id='id_span'></SPAN> <!-- ID 중복 관련 메시지 -->        
                  </div>
                </div>
                
                <div class="form-group">
                  <label for="passwd" class="col-md-10 control-label" style='font-size: 0.9em;'>패스워드 <span class="essential">*</span></label>    
                  <div class="col-md-10" style="display: inline-block;">
                    <input type='password' class="form-control" name='passwd' id='passwd' value='' required="required" placeholder="패스워드">        
                  </div>
                </div>
                
                <div class="form-group">
                  <label for="passwd2" class="col-md-10 control-label" style='font-size: 0.9em;'>패스워드 확인 <span class="essential">*</span></label>    
                  <div class="col-md-10" style="display: inline-block;">
                    <input type='password' class="form-control" name='passwd2' id='passwd2' value='' required="required" placeholder="패스워드 확인">        
                  </div>
                </div>
                
                <div class="form-group">
                  <label for="mname" class="col-md-10 control-label" style='font-size: 0.9em;'>성명 <span class="essential">*</span></label>    
                  <div class="col-md-10" style="display: inline-block;">
                    <input type='text' class="form-control" name='mname' id='mname' value='' required="required" placeholder="성명">        
                  </div>
                </div>
                
                <div class="form-group">
                  <label for="email" class="col-md-10 control-label" style='font-size: 0.9em;'>E-Mail <span class="essential">*</span></label>    
                  <div class="col-md-10" style="display: inline-block;">
                    <input type='email' class="form-control" name='email' id='email' value='' required="required" placeholder="E-Mail">        
                  </div>
                </div>
                
                <div class="form-group">
                  <label for="tel" class="col-md-10 control-label" style='font-size: 0.9em;'>전화번호 <span class="essential">*</span></label>    
                  <div class="col-md-10" style="display: inline-block;">
                    <input type='text' class="form-control" name='tel' id='tel' 
                               value='' required="required" placeholder="010-0000-0000"> 
                  </div>
                </div>   
            
                <div class="form-group">
                  <label for="zipcode" class="col-md-10 control-label" style='font-size: 0.9em;'>우편번호</label>    
                  <div class="col-md-10" style="display: inline-block;">
                ...
                <div class="form-group">
                  <label for="address1" class="col-md-10 control-label" style='font-size: 0.9em;'>주소</label>    
                  <div class="col-md-10" style="display: inline-block;">
                ...
                <div class="form-group">
                  <label for="address2" class="col-md-10 control-label" style='font-size: 0.9em;'>상세 주소</label>    
                  <div class="col-md-10" style="display: inline-block;">
                    <input type='text' class="form-control" name='address2' id='address2' 
                               value='' placeholder="상세 주소">
                  </div>
                </div>
